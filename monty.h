...
void func_stack(stack_t **head, unsigned int cntr);
...
void func_mod(stack_t **head, unsigned int cntr);
void func_add(stack_t **head, unsigned int cntr);
void func_pall(stack_t **head, unsigned int number);
void func_prnt(stack_t **head, unsigned int number);
void func_nop(stack_t **head, unsigned int cntr);
void func_sub(stack_t **head, unsigned int cntr);
void func_div(stack_t **head, unsigned int cntr);
void func_rot(stack_t **head, unsigned int cntr);
